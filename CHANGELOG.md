...
### Fixed
- Ignore `dist/` and `build/` directories so release wheels keep the tag version instead of being marked dirty by the build's own untracked artifacts (osism/netbox-manager#298)
